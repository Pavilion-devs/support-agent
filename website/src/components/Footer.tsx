    ...
    <footer className="w-full py-16 px-6 md:px-12 border-t border-border bg-card">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground max-w-xs">
              AI-powered customer support for B2B teams that value efficiency, accuracy, and growth.
            </p>
            <div className="flex items-center gap-4">
              <a href="https://x.com/usetwisky" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center text-muted-foreground text-sm">
          <div>© 2025 Twisky. All rights reserved.</div>
