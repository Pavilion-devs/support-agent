      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        >
          ...
          <p className="text-cosmic-muted text-lg">
            Monitor conversations, escalations, and knowledge base updates in real-time
          </p>
        </div>
        
        <div 
          className={`cosmic-glow relative rounded-xl overflow-hidden dashboard-container backdrop-blur-sm transition-all duration-1000 delay-300 ${
        ...
        >
          ...
          <div className="dashboard-content backdrop-blur-md w-full">
            {/* Dashboard Header */}
            <div className="flex items-center justify-between p-4 dashboard-header">
              <div className="flex items-center gap-4">
                ...
                <span className="dashboard-title font-medium">Customer Support Dashboard</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="h-8 px-3 rounded-md bg-cosmic-light/10 flex items-center justify-center dashboard-text text-sm">
                  Share
                </div>
              </div>
            </div>
            ...
            <div className="flex h-[500px] overflow-hidden">
              {/* Sidebar */}
              <div className="w-64 dashboard-sidebar p-4 space-y-4">
                <div className="space-y-2">
                  <div className="text-xs text-cosmic-muted uppercase">Navigation</div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md bg-cosmic-light/10 dashboard-active">
                      <div className="h-3 w-3 rounded-sm bg-cosmic-accent"></div>
                      <span>Support Board</span>
                    </div>
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md dashboard-inactive hover:bg-cosmic-light/5">
                ...
                <div className="space-y-2 pt-4">
                  <div className="text-xs text-cosmic-muted uppercase">Channels</div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md dashboard-inactive hover:bg-cosmic-light/5">
              ...
              <div className="flex-1 p-4">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2">
                    <h3 className="font-medium">Support Activities</h3>
